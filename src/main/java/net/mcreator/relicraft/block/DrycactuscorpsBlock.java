...
public class DrycactuscorpsBlock extends RelicraftModElements.ModElement {
	@ObjectHolder("relicraft:drycactuscorps")
	public static final Block block = null;
	public DrycactuscorpsBlock(RelicraftModElements instance) {
		super(instance, 21);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.CACTUS).sound(SoundType.WOOD).hardnessAndResistance(0.6f, 0.5f).setLightLevel(s -> 0)
					.harvestLevel(1).harvestTool(ToolType.AXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("drycactuscorps");
		}
