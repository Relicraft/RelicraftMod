...
import net.mcreator.relicraft.procedures.InfusingOreBlockDestroyedByPlayerProcedure;
...
public class InfusingOreBlock extends RelicraftModElements.ModElement {
	@ObjectHolder("relicraft:infusing_ore")
	public static final Block block = null;
	public InfusingOreBlock(RelicraftModElements instance) {
		super(instance, 11);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(InfusingPowderItem.block));
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				InfusingOreBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("relicraft:infusing_ore_match"), () -> CustomRuleTest.codec);
